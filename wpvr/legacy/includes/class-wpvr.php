...
class Wpvr
{
	...
	private function load_dependencies()
	{
		 ...
		 */
		if ( file_exists( dirname( plugin_dir_path( __DIR__ ) ) . '/vendor/autoload.php' ) ) {
			require_once dirname( plugin_dir_path( __DIR__ ) ) . '/vendor/autoload.php';
		} else {
	...
	private function define_public_hooks()
	{
		...
		if (method_exists($plugin_public, 'fix_script_deps')) {
			$this->loader->add_action('wp_enqueue_scripts', $plugin_public, 'fix_script_deps', 20);
		}
