...
class Wpvr_Ajax
{
  ...
  function __construct()
  {
    ...
    add_action('wp_ajax_wpvr_enable_large_image_handler', array($this, 'wpvr_enable_large_image_handler'));
  ...
  /**
   * Enable full-resolution images without changing other settings.
   *
   * @return void
   */
  public function wpvr_enable_large_image_handler()
  {
    ...
    update_option('high_res_image', 'true');
  ...
  public function wpvr_file_import()
  {
    ...
    $file_name = '';
      ...
      if (
        isset( $_FILES['wpvr_import_file'] )
        && $_FILES['wpvr_import_file']['error'] === UPLOAD_ERR_OK
        && ! empty( $_FILES['wpvr_import_file']['tmp_name'] )
      ) {
          ...
          $upload_error = isset( $_FILES['wpvr_import_file']['error'] ) ? (int) $_FILES['wpvr_import_file']['error'] : -1;
          ...
          $message = isset( $error_messages[ $upload_error ] ) ? $error_messages[ $upload_error ] : 'No file selected.';
