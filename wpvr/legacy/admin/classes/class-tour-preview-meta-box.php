            ...
            <script>
                ...
                if (scenes) {
                    ...
                    jQuery.each(scenes.scenes, function(key, val) {
                        ...
                        jQuery('.scene-gallery').append('<ul style="width:150px;"><li class="owlscene owl' + key + '">' + key + '</li><li title="Click to view scene"><img loading="lazy" class="scctrl" id="' + key + '_gallery" src="' + img_data + '"></li></ul>');
                    });
                }
                    ...
                    if (scenes) {
                        jQuery.each(scenes.scenes, function(key, val) {
                            document.getElementById('' + key + '_gallery').addEventListener('click', function(e) {
                                jQuery('.owl-item').removeClass('marked');
                                jQuery(this).closest('.owl-item').addClass('marked');
