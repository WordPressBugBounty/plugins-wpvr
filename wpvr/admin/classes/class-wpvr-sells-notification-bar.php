            ...
            <div class="wpvr-promo-banner__container">
                <h2 class="wpvr-promo-banner__title" id="wpvr-promo-banner-title">
                    <a href="<?php echo esc_url($btn_link); ?>"  target ="_blank" class="wpvr-promo-banner__link" aria-label="Get Special Discount">
                        <?php echo esc_html__('Get ', 'wpvr'); ?><strong class="wpvr-promo-banner__discount"><?php echo esc_html__('15% ', 'wpvr'); ?></strong><?php echo esc_html__(' Discount On ', 'wpvr'); ?><strong class="wpvr-promo-banner__discount"><?php echo esc_html__('WPVR', 'wpvr'); ?></strong>
