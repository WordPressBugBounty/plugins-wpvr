    ...
    <ul class="tabs tabs-icon rex-tabs">
        <li class="tab col s3 wpvr_tabs_row">
            <a href="#">
                ...
                <?php esc_html_e( 'Free vs Pro', 'wpvr' ); ?>
            </a>
        </li>
    </ul>
    ...
    <div class="block-wrapper">
        <div class="wpvr-compare">
            <?php
                ...
                echo wp_kses_post('<div class="compare-tbl-wrapper">');
                    echo wp_kses_post('<div class="comparison-tbl-wrapper-area">');

                        echo wp_kses_post('<ul class="single-feature list-header">');
                        echo wp_kses_post('<li class="comparison-tbl-col feature">' . esc_html__('features', 'wpvr') . '</li>');
                        echo wp_kses_post('<li class="comparison-tbl-col free">' . esc_html__('free', 'wpvr') . '</li>');
                        echo wp_kses_post('<li class="comparison-tbl-col pro">' . esc_html__('pro', 'wpvr') . '</li>');
                        echo wp_kses_post('</ul>');

                        echo wp_kses_post('<div class="comparison-tbl-body">');

                            foreach ($features as $index => $feature) {
                                echo wp_kses_post('<ul class="single-feature feature-list">');

                                    echo wp_kses_post('<li class="comparison-tbl-col feature"><p>' . esc_html($feature) . '</p></li>');
                                    echo wp_kses_post('<li class="comparison-tbl-col free"><span class="icon no"><img loading="lazy" src="' . esc_url(WPVR_PLUGIN_DIR_URL . 'admin/icon/' . $free_icons[$index] . '.svg') . '" alt="' . esc_attr($free_icons[$index]) . '"></span></li>');
                                    echo wp_kses_post('<li class="comparison-tbl-col pro"><span class="icon yes"><img loading="lazy" src="' . esc_url(WPVR_PLUGIN_DIR_URL . 'admin/icon/' . $pro_icons[$index] . '.svg') . '" alt="' . esc_attr($pro_icons[$index]) . '"></span></li>');
                    ...
                    echo wp_kses_post('<div class="comparison-tbl-footer">');
                        echo wp_kses_post('<div class="footer-btn comparison-tbl-col">');
