...
<div id="onboarding-app" class="step-vertical">

    <!-- Steps 1-4 container with sidebar -->
    <div class="steps-container" id="steps-container" style="display: flex;">
        <!-- Remind me later button positioned outside container -->
        <button class="btn-skip" id="wizard-exit"><?php echo esc_html__('Remind me later', 'wpvr'); ?></button>
        ...
        <aside class="sidebar" id="main-sidebar">
            ...
            <nav class="nav-steps">
                <div class="nav-item active" data-step="step-vertical" data-number="1"><span class="nav-text">Industry</span></div>
        ...
        <section class="step active full-width" id="step-vertical">
            <div class="step-progress">
                <div class="step-seg filled"></div><div class="step-seg"></div><div class="step-seg"></div><div class="step-seg"></div>
            ...
            <div class="skip-industry-container">
                <a href="#" id="skip-industry-link" class="skip-link"><?php echo esc_html__("Skip — I'll upload my own image", 'wpvr'); ?></a>
            </div>

            <footer class="onboarding-footer" style="display: none;">
                <!-- Hide footer for Step 1 -->
            </footer>
        </section>
        ...
        <section class="step" id="step-template">
            <div class="step-progress">
                <div class="step-seg filled"></div><div class="step-seg filled"></div><div class="step-seg"></div><div class="step-seg"></div>
            ...
            <div class="template-container">
                ...
                <div class="template-cta-row">
                    <button class="btn-use-template" id="use-template-btn"><?php echo esc_html__('USE PROPERTY TEMPLATE', 'wpvr'); ?></button>
                </div>
            </div>

            <footer class="onboarding-footer template-footer">
        ...
        <section class="step" id="step-preview">
            <div class="step-progress">
                <div class="step-seg filled"></div><div class="step-seg filled"></div><div class="step-seg filled"></div><div class="step-seg"></div>
            ...
            <footer class="onboarding-footer">
                ...
                <div class="footer-right">
                    <button class="btn-primary-outline next-btn" data-next="step-success" id="publish-btn"><?php echo esc_html__('Publish Tour', 'wpvr'); ?></button>
                </div>
            </footer>
        </section>
        ...
        <section class="step" id="step-success">
            <div class="step-progress">
                <div class="step-seg filled"></div><div class="step-seg filled"></div><div class="step-seg filled"></div><div class="step-seg filled"></div>
            ...
            <!-- Telemetry Consent Block -->
            <div class="wizard-consent-block">
                <label class="consent-label" for="consent-checkbox">
                    <input type="checkbox" id="consent-checkbox" name="consent-checkbox" checked>
                    <span>
                        <?php echo esc_html__('I agree to share non-sensitive diagnostic data to help improve WP VR.', 'wpvr'); ?>
                        <br><small style="font-weight: normal; font-size: 11px; opacity: 0.8;"><?php echo esc_html__('(You can change this in WP VR settings anytime)', 'wpvr'); ?></small>
                    </span>
                </label>
            </div>
